...
def add_review(request, product_id):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(
                request, 'Thank you {0} for your {1} review!'.format(
                    user_name, product)
                    )
    else:
        form = ReviewForm()
